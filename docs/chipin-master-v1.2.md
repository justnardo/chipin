...
2. Corporate sponsorships: Banks, insurers, telecommunications companies, and other
aligned organizations may sponsor the service without controlling campaign review or
outcomes.
3. Government and NGO partnerships: Explore blood-donation and civic-service
partnerships after the pilot demonstrates reliable operations.
4. Organizational tier: Churches, NGOs, schools, and businesses may later pay for
optional recurring campaign management and reporting tools.
5. Optional platform support: Introduce donor tips only as a separate future product after
...
6. Free-use policy --- LOCKED: All personal campaigns remain free of platform fees.
...
9. Rollout Plan and Exit Criteria
...
security, reconciliation, refund, and dispute requirements are understood.
10. Success Measures
Monetary MVP
...
donor protection, or funds-use verification.
...
2. Bank/channel evidence matrix --- ACTIVE, critical path. Test protocol, live transfer
testing across bank pairs and channels, findings, and the reference-vs-fallback decision.
3. Pledge, transfer-reconciliation, moderation-case, and campaign state-machine
specification.
4. Review, moderation, acceptable-use, takedown, and material-change operations
playbook (pilot-scale per Principle 7).
5. Data-category matrix and privacy, authority, retention, deletion, consent, ownership,
audit, and document-access policy reviewed per §5.3 pragmatic path.
6. Threat model and testable security release checklist.
7. Supabase schema with independently tested RLS, private storage policies, event
history, correction, and deletion behavior.
8. Controlled-pilot plan with campaign mix, partners, reviewer independence, staffing,
committed runway, numeric success thresholds, and stop/wind-down conditions.
14. Position in the FGB Pipeline
