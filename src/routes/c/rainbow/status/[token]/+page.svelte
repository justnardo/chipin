...
<header class="site-header">
	...
	<a class="back" href={resolve('/c/rainbow')}>Campaign</a>
</header>
...
<main>
	...
	{:else if !report}
		<section class="card">
			...
			<a class="primary" href={resolve('/c/rainbow/chip-in')}>Start chip-in flow</a>
		</section>
	...
	{:else}
		...
		<p class="lede">Hosted by {campaign.host}. ChipIn records reports and host marks — it does not move money.</p>
		...
		<section class="card">
			...
			<div class="footer-actions">
				<a class="ghost" href={resolve('/c/rainbow')}>View campaign</a>
				<a class="ghost" href={resolve('/c/rainbow/host')}>Open host view</a>
