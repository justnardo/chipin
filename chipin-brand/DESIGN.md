...
understood, rewrite the label. 2. Logo System
...
Line-height: 1.5 body, 1.15 display. Campaign stories: max-width 65ch. 5. Spacing, Layout, Radius, Elevation
...
(.visually-hidden, .stack, .cluster, etc.). No utility framework. 7. Signature Components
...
the real Bahamian mobile context. 10. Social & Sharing Surfaces
...
└── chipin-matched-set.png ← reference sheet 12. Drop-in replacement for Master Document §6
